...
// 🔹 NOVO: rota de teste de prompt para o FlowBuilder (OpenAI / Gemini)
routes.post("/ai/test-prompt", isAuth, AiTestController.handle);
// se quiser sem autenticação, pode usar:
// routes.post("/ai/test-prompt", AiTestController.handle);
